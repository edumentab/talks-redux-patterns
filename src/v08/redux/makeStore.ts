...
For the production store we pass in a `consGetter` returning all the consequence definitions in our app (<span data-file-link="./slices/rebrickable/actions/loadSetsInit"><code>loadSetsInit</code></span> and <span data-file-link="./slices/rebrickable/actions/loadThemesInit"><code>loadThemesInit</code></span>).
*/
