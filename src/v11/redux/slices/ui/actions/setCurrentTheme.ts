...
In conjunction we move testing logic from <span data-file-link="../../../../app/Theme.test"><code>Theme.test</code></span> to <span data-file-link="./setCurrentTheme.consequence.test"><code>setCurrentTheme.consequence.test</code></span>.
*/
