...
Our <span data-file-link="./Theme.test">tests</span> for this components have therefore been simplified as the responsibility of testing the logic has moved to <span data-file-link="../redux/slices/ui/actions/setCurrentTheme.consequence.test"><code>setCurrentTheme.consequence.test</code></span>.
*/
