...
The same change was made in the tests for <span data-file-link="./Main.test"><code>Main</code></span>, <span data-file-link="./Theme.test"><code>Theme</code></span>, <span data-file-link="./SetSelector.test"><code>SetSelector</code></span> and <span data-file-link="./ThemeSelector.test"><code>ThemeSelector</code></span>.
*/
