...
The same change was made in the tests for <span data-file-link="./Guess.test"><code>Guess</code></span>, <span data-file-link="./Main.test"><code>Main</code></span> and <span data-file-link="./SetSelector.test"><code>SetSelector</code></span>.
*/
